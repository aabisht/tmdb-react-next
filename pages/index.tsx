          ...
          <div className="relative w-full px-6 py-12 bg-white shadow-xl shadow-slate-700/10 ring-1 ring-gray-900/5 md:max-w-3xl md:mx-auto lg:max-w-4xl lg:pt-16 lg:pb-28">
            ...
            <div className="mt-8 prose prose-slate mx-auto lg:prose-lg">
              ...
              <p>
                ...
                doubt you really want your blog posts to use the user-agent
                styles either — you want them to look <em>awesome</em>, not
                awful.
              </p>
              <p>
              ...
              <p>
                It adds a new <code>prose</code> className that you can slap on
                any block of vanilla HTML content and turn it into a beautiful,
                well-formatted document:
              </p>
              <pre>
                <code className="language-html">
                  &lt;article className=&quot;prose&quot;&gt; &lt;h1&gt;Garlic
                  bread with cheese: What the science tells us&lt;/h1&gt;
                  &lt;p&gt; For years parents have espoused the health benefits
                  of eating garlic bread with cheese to their children, with the
              ...
              <p>
                Now I&apos;m going to show you an example of an unordered list
                to make sure that looks good, too:
              </p>
              <ul>
              ...
              <ul>
                ...
                <li>
                  ...
                  <p>
                    ...
                    items but three is definitely not worse, and since I seem to
                    be having no trouble making up arbitrary things to type, I
              ...
              <p>
                ...
                want to style their code blocks but it wouldn&apos;t hurt to
              ...
              <p>
                ...
                Medium don&apos;t even let you do it, but I guess since some of
                you goofballs are going to do it we have to carry the burden of
                  ...
                  <ul>
                    <li>
                      <p>
                        ...
                        line, this list item now has a <code>&lt;p&gt;</code>{" "}
                        tag.
                      </p>
                      <p>
              ...
              <p>
                ...
                <code>code</code> tag inside of a link, like if I wanted to tell
                you about the{" "}
              ...
              <p>
                ...
                think things will look weird or unbalanced if there is a heading
